...
def main():
    ...
    parser.add_argument("--num_workers", type=int, default=64, help="Workers for mp backend (set lower if you saturate cores)")
    parser.add_argument("--vec_batch_size", type=int, default=252, help="Vecenv batch size for MP backend (controls worker barrier)")
